...
exports.User = exports.Record = exports.RecordChallenges = exports.RecordContent = exports.Challenge = void 0;
...
exports.RecordContent = zod_1.z.object({
    content: zod_1.z.string(),
    hash: zod_1.z.string()
});
// Represents a record's challenges
exports.RecordChallenges = zod_1.z.object({
...
exports.Record = zod_1.z.object({
    id: zod_1.z.string()
}).and(exports.RecordContent).and(exports.RecordChallenges);
